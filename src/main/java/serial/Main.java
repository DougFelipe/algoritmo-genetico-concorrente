...
public class Main {
    public static void main(String[] args) {
        if (args.length < 1) {
            System.err.println("Uso: java -cp out serial.Main <caminho_dataset>");
            System.exit(1);
        }
        ...
        GeneticAlgorithm ga = new GeneticAlgorithm(dados, tamanhoPopulacao, numGeracoes, taxaCrossover, taxaMutacao);
        ga.executar();
